...
namespace DisasterPlus.Core.Tests.Earthquake
{
    ...
    public class TsunamiRingShapeTests
    {
        ...
        {
            Assert.Equal(0, TsunamiRingShape.LevelOffsetUnits(0, 7447));
            Assert.Equal(0, TsunamiRingShape.LevelOffsetUnits(-64, 7447));
            Assert.Equal(0, TsunamiRingShape.LevelOffsetUnits(
                TsunamiRingShape.DurationTicks, 7447));
            Assert.Equal(0, TsunamiRingShape.LevelOffsetUnits(8192, 0));
        }
        ...
        public void The_crest_is_in_the_middle_and_equals_the_decayed_amplitude()
        {
            ...
            int got = TsunamiRingShape.LevelOffsetUnits(half, 7447);
        ...
        public void Retreat_comes_before_and_after_the_crest()
        {
            ...
            int early = TsunamiRingShape.LevelOffsetUnits(T / 6, 7447);
            int crest = TsunamiRingShape.LevelOffsetUnits(T / 2, 7447);
            int late = TsunamiRingShape.LevelOffsetUnits(T * 5 / 6, 7447);
        ...
        public void The_waveform_crosses_zero_at_one_third_and_two_thirds()
        {
            ...
            Assert.InRange(TsunamiRingShape.LevelOffsetUnits(T / 3, 7447), -40, 40);
            Assert.InRange(TsunamiRingShape.LevelOffsetUnits(T * 2 / 3, 7447), -40, 40);
        }
        ...
        public void The_offset_never_leaves_the_representable_range()
        {
            ...
            {
                int off = TsunamiRingShape.LevelOffsetUnits(t, 18991);
